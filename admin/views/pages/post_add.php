  ...
  <header id="header">
    ...
    <div class="container-fluid">
      <ul class="breadcrumb bg-dark text-white">
        ...
        <li class="breadcrumb-item active bg-dark text-white">Add</li>
      </ul>
    </div>
    ...
    <div class="container-fluid">
      ...
      <div class="col-md-10">   
        <div class="card">
          ...
          <div class="card-body">
            <form id="postFormAdd" action="/post/add_new/" method="post" enctype="multipart/form-data">
              <div class="form-group form-inline required">
                <label class="control-label">Title</label>
                <input name="title" required type="text" class="form-control inline-quarter-size" placeholder="Post Title">
              </div>
              <div class="form-group form-inline required">
                <label class="control-label">URL Name</label>
                <input name="url_name" type="text" class="form-control inline-quarter-size" placeholder="URL Name">
              </div>
              ...
              <div class="form-group form-inline required">
                ...
                <select name="category_id" class="form-control inline-quarter-size" id="sel1">                  
                  <?php
              ...
              <div class="form-group required">
                ...
                <input name="description" required type="text" class="form-control" placeholder="Add Description...">
              </div>
              <div class="form-group required">
                <label class="control-label">Text</label>
                <textarea required name="editor1" class="form-control" placeholder="Post Body"></textarea>
              </div>
